...
//     >
//       <Text style={[styles.sectionTitle, { color: colors.text }]}>
//         Welcome to <span className="uppercase">{storeName}</span>
//       </Text>
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         {storeName} is your all-in-one data and utility payment destination.
//         Discover, purchase, and manage data bundles and utility services — all
...
//     >
//       <Text style={[styles.sectionTitle, { color: colors.text }]}>
//         Mavin Player Privacy
//       </Text>
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         Mavin Player is committed to protecting your personal data. By enabling
//         this feature you confirm you have read and agree to Mavin Player's legal
//         documentation:
//       </Text>
//       <Text style={[styles.bulletItem, { color: colors.textSecondary }]}>
//         {"•  "}
...
//       <Text style={[styles.bulletItem, { color: colors.textSecondary }]}>
//         {"•  "}
//         <LinkText url={URLS.pawnsPrivacyPolicy} colors={colors}>
//           Pawns Privacy Policy
//         </LinkText>
//       </Text>
//       <Text style={[styles.bulletItem, { color: colors.textSecondary }]}>
//         {"•  "}
//         <LinkText url={URLS.pawnsAcceptableUse} colors={colors}>
//           Pawns Acceptable Use Policy
//         </LinkText>
//       </Text>
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         The SDK may collect device identifiers, IP addresses, and bandwidth
//         usage statistics as described in the Pawns Privacy Policy. Mavin Player
//         does not receive or store this data.
//       </Text>
//     </ScrollView>
//   );
...
// function DataProtectionTab({ colors }: { colors: any }) {
//   return (
//     <ScrollView
//       style={styles.tabContent}
//       contentContainerStyle={styles.tabContentContainer}
...
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         All traffic passing through your device while the earnings feature is
//         active is fully encrypted using industry-standard TLS protocols. Mavin
//         Player never has access to the contents of this traffic — and neither
//         does anyone on your local network.
//       </Text>
...
//         device using Android's SharedPreferences and React Native's
//         AsyncStorage. This data never leaves your device and is never
//         transmitted to Mavin Player's servers or any third party.
//       </Text>
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         Consent records are retained on-device for 24 months from each event
//         date to support legal compliance and let you audit your consent history
...
//       </Text>
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         Mavin Player does not sell, rent, or share your personal information
//         with advertisers or data brokers. Your account data, listening history,
//         and device identifiers held by Mavin Player are kept strictly separate
//         from the bandwidth sharing feature.
//       </Text>
...
//       </Text>
//       <Text style={[styles.bulletItem, { color: colors.textSecondary }]}>
//         {"•  "}Access the personal data Mavin Player holds about you
//       </Text>
//       <Text style={[styles.bulletItem, { color: colors.textSecondary }]}>
//         {"•  "}Request correction of inaccurate data
//       </Text>
...
//         <LinkText url={URLS.appPrivacyPolicy} colors={colors}>
//           Privacy Policy
//         </LinkText>
//         . For rights regarding Pawns data, contact Pawns via their{" "}
//         <LinkText url={URLS.pawnsPrivacyPolicy} colors={colors}>
...
//       </Text>
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         For any data protection enquiry relating to Mavin Player, use the
...
// function DataSharingTab({ colors }: { colors: any }) {
//   return (
//     <ScrollView
//       style={styles.tabContent}
//       contentContainerStyle={styles.tabContentContainer}
...
//       </Text>
//       <Text style={[styles.bodyText, { color: colors.textSecondary }]}>
//         Mavin Player's bandwidth sharing feature is powered entirely by the
//         Pawns SDK. Pawns connects devices sharing idle bandwidth with businesses
//         that need distributed network infrastructure. The disclosures below are
//         required by Pawns SDK Terms §3.6.5.
//       </Text>
...
//   try {
//     await AsyncStorage.removeItem(CONSENT_STORAGE_KEY);
//     // TODO: Call Pawns SDK stop/opt-out method if needed
//     console.log("[EarningsConsentGate] Consent revoked");
//   } catch (err) {
//     console.error("[EarningsConsentGate] Failed to revoke consent:", err);
//   }
...
// }: EarningsConsentGateProps) {
//   const { colors, isDark } = useTheme();
//  const storeName = useResellerStore.getState().config.storeName || "the App";
//   const [activeTab, setActiveTab] = useState<Tab>("General");
//   const [consentGiven, setConsentGiven] = useState(false);
//   const [isLoading, setIsLoading] = useState(false);
...
//         return <GeneralTab colors={colors} storeName={storeName} />;
//       case "Privacy":
//         return <PrivacyTab colors={colors} />;
//       case "Data Protection":
