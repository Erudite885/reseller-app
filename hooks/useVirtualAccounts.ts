...
//  * alan+1@gmail.com    → alan+1soledad1@gmail.com  (already has +, no extra +)
//  */
...
//   return `${localPart}${separator}${storeSlug}${suffix}@${domain}`;
// }
...
//         },
//         body: JSON.stringify({ storeSlug, userId: user.id }),
//       });
